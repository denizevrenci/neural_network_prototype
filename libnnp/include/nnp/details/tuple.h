...
using TupleSequence = std::make_index_sequence<std::tuple_size<std::remove_reference_t<Tuple>>::value>;
...
constexpr void forEachHelper(const Tuple& tuple, Callable&& c, std::index_sequence<HEAD, TAIL...>) {
